          ...
          <div className="relative mb-4">
            <Avatar className="w-32 h-32">
              {profile.avatar_url ? (
                ...
                <AvatarFallback className="bg-primary text-primary-foreground w-full h-full flex items-center justify-center text-3xl">
            ...
            <div className="absolute -bottom-2 -right-2">
              ...
              >
                {isUploading ? <Spinner size="sm" /> : <Image size={16} />}
              </Button>
              <input 
                id="avatar-upload" 
                type="file" 
