...
import { egyptianGovernorates as governorates } from "@/data/egyptianGovernorates";
import { citiesByGovernorate as cities } from "@/data/egyptianCities";
...
const PostJobForm = () => {
  ...
  useEffect(() => {
    if (formData.governorate && cities[formData.governorate]) {
      ...
      const filteredCities = cities[formData.governorate].filter(city => city && city.trim() !== '');
          ...
          <div>
            ...
            >
              <SelectTrigger id="city">
                <SelectValue placeholder={!formData.governorate ? "اختر المحافظة أولاً" : "اختر المدينة"} />
              </SelectTrigger>
              <SelectContent>
